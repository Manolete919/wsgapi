...
@Singleton
@Startup
public class PanelEjbLogger implements Serializable {
	...
	public void inicializarLog4j() {
		...
		try {
			...
			InputStream iostream = Thread.currentThread()
					...
					.getResourceAsStream("properties/log4j-ejb.properties");
		...
		logger = Logger.getLogger(PanelEjbLogger.class);
