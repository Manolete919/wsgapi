...
@Singleton
@Startup
public class PanelWebLogger implements Serializable {
	...
	public void inicializarLog4j() {
		...
		try {
			...
			InputStream iostream = Thread.currentThread().getContextClassLoader().getResourceAsStream("properties/log4j-web.properties");
		...
		logger = Logger.getLogger(PanelWebLogger.class);
